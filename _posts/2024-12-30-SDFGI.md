...
toc: true
description: <span class="highlighter">Dynamic Diffuse Global Illumination</span> using SDFs, that <span class="highlighter">doesn't need ray-tracing hardware</span>. Written in <span class="highlighter">DirectX 12</span>.
